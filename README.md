...
- 상품 목록
  - 상품명, 가격, 재고 수량, 적용된 행사명

#### 행사 관리
- 행사 목록
  - 행사명, 증정 기준 수량, 증정 수량, 적용 날짜
...
- 상품 목록을 파일 입출력을 통해 불러온다. `src/main/resources/products.md`
- 행사 목록을 파일 입출력을 통해 불러온다. `src/main/resources/promotions.md`
...
- 구매자가 구매할상품과 수량을 입력받는 기능

#### 출력

- 상품 재고를 출력하는 기능
- 구매자와 상호작용하는 메시지를 출력하는 기능
  - 적용 가능한 프로모션 상품 수량만큼 가져오지 않은 경우
  - 프로모션 재고가 부족한 경우
  - 멤버십 할인 적용
  - 추가 구매 여부
- 영수증을 출력하는 기능
